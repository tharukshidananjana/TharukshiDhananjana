...
# District Options
DISTRICT_OPTIONS = [
    'COLOMBO', 'GAMPAHA', 'KALUTHARA', 'MATHALE', 'KANDY', 'NUWARA ELIYA', 'GALLE', 
...
PRIMARY_FIELD_OPTIONS = ['Engineering', 'Medicine', 'IT', 'Law', 'Arts', 'Management', 
                         'Bio science Technology', 'Applied science', 'Design', 
                         'Statistics', 'Agriculture', 'Nursing', 'Pharmacy']
